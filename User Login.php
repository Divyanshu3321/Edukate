            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-7">
                    <div class="section-title position-relative mb-4">
                        <h6 class="d-inline-block position-relative text-secondary text-uppercase pb-2">Welome User Let's Login ?</h6>
                    ...
                    <div class="contact-form">
                        <form method ="Post" enctype = "multipart/form-data">
                            ...
                            <div>
                                ...
                                <a href="User Register.php">Let's Register ? </a>
                        ...
                        <?php 
                            ...
                            if(isset($_POST['submit']))     // this all is format expect the query
                            {
                                ...
                                $query= "select username, password from user_register where username = '$username' and password = '$password'";  
                                $result = insert_select_delete($con, $query); 
                                if (mysqli_num_rows($result) > 0)     // if successful make a session 
                                {
                                    $_SESSION['username']=$_POST['username'];   // session made pick his username  $_SESSION['username'] is a session used in profile.php // profile php include header so opened session only in header jo aga haar jgah use kara ga hum so no need to open it again and again 
                                    header("Location:User/Profile.php");            // redirect it to profile.php
                                    print("<br>Successful"); 
                                } else 
                                {
                                    echo '<br> Not Found';
