            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-7">
                    <div class="section-title position-relative mb-4">
                        <h6 class="d-inline-block position-relative text-secondary text-uppercase pb-2">Welcome Admin</h6>
                        ...
                        <?php 
                            ...
                            if(isset($_POST['submit']))     // this all is format expect the query
                            {
                                ...
                                if (mysqli_num_rows($result) > 0) 
                                {
                                    ...
                                    header("Location:Admin/Profile.php");            // redirect it to profile.php // session aak baar header ma khol diya bss aur kahi jarurt nhi padi kholna ki 
                                    print("<br>Successful"); 
                                } else 
                                {
                                    echo '<br> Not Found';
